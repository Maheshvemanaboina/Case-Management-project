            ...
            action.setCallback(this, function(response) {
                ...
                if(status === "SUCCESS") {
                    ...
                    if(!$A.util.isUndefinedOrNull(result)){
                        ...
                        let opportunityInstructionDocumentId = result.opportunityInstructionDocumentId;
                        if(!$A.util.isUndefinedOrNull(opportunityInstructionDocumentId)){
                            let baseUrl = component.get('v.baseUrl');
                            let iframeUrl = baseUrl + '/servlet/servlet.FileDownload?file=' +opportunityInstructionDocumentId;
